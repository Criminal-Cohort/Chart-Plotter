...
low_frame_find_live.grid(row=1, column=0, columnspan=2, padx=10, pady=10, sticky='ew')
...
days_ticker.grid(row=1, column=1, padx=(0, 10), pady=10, sticky='e')

entry_days = ttk.Entry(low_frame_find_live, font=default_font, width=15)
entry_days.grid(row=1, column=2, padx=(10, 0), pady=10, sticky='e')

find_button = tk.Button(find_live_tab, text="Find", font=default_font, width=14, command=lambda: handle_find_live())
find_button.grid(row=2, column=1, padx=(10, 0), pady=5, sticky='e')

text_area_find_live = tk.Text(find_live_tab, font=default_font)
text_area_find_live.grid(row=3, column=0, columnspan=2, padx=10, pady=10, sticky='nsew')
